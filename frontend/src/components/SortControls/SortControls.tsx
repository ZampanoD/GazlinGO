...
//Поддерживает условное отображение опции избранного для авторизованных пользователей.
//Использует систему пропсов для гибкой настройки отображения и управления состоянием сортировки.
